...
public class MySqlLexer extends Lexer {
	...
	public static final int
		...
		UTC_TIME=299, UTC_TIMESTAMP=300, ACCOUNT=301, ACTION=302, ADMIN=303, NULL=304, 
		OPTIONAL=305, AFTER=306, AGGREGATE=307, ALGORITHM=308, ANY=309, AT=310, 
		AUTHORS=311, AUTOCOMMIT=312, AUTOEXTEND_SIZE=313, AUTO_INCREMENT=314, 
		AVG_ROW_LENGTH=315, BEGIN=316, BINLOG=317, BIT=318, BLOCK=319, BOOL=320, 
		BOOLEAN=321, BTREE=322, CACHE=323, CASCADED=324, CHAIN=325, CHANGED=326, 
		CHANNEL=327, CHECKSUM=328, PAGE_CHECKSUM=329, CIPHER=330, CLASS_ORIGIN=331, 
		CLIENT=332, CLOSE=333, COALESCE=334, CODE=335, COLUMNS=336, COLUMN_FORMAT=337, 
		COLUMN_NAME=338, COMMENT=339, COMMIT=340, COMPACT=341, COMPLETION=342, 
		COMPRESSED=343, COMPRESSION=344, CONCURRENT=345, CONNECTION=346, CONSISTENT=347, 
		CONSTRAINT_CATALOG=348, CONSTRAINT_SCHEMA=349, CONSTRAINT_NAME=350, CONTAINS=351, 
		CONTEXT=352, CONTRIBUTORS=353, COPY=354, CPU=355, CURSOR_NAME=356, DATA=357, 
		DATAFILE=358, DEALLOCATE=359, DEFAULT_AUTH=360, DEFINER=361, DELAY_KEY_WRITE=362, 
		DES_KEY_FILE=363, DIRECTORY=364, DISABLE=365, DISCARD=366, DISK=367, DO=368, 
		DUMPFILE=369, DUPLICATE=370, DYNAMIC=371, ENABLE=372, ENCRYPTION=373, 
		END=374, ENDS=375, ENGINE=376, ENGINES=377, ERROR=378, ERRORS=379, ESCAPE=380, 
		EVEN=381, EVENT=382, EVENTS=383, EVERY=384, EXCHANGE=385, EXCLUSIVE=386, 
		EXPIRE=387, EXPORT=388, EXTENDED=389, EXTENT_SIZE=390, FAST=391, FAULTS=392, 
		FIELDS=393, FILE_BLOCK_SIZE=394, FILTER=395, FIRST=396, FIXED=397, FLUSH=398, 
		FOLLOWS=399, FOUND=400, FULL=401, FUNCTION=402, GENERAL=403, GLOBAL=404, 
		GRANTS=405, GROUP_REPLICATION=406, HANDLER=407, HASH=408, HELP=409, HOST=410, 
		HOSTS=411, IDENTIFIED=412, IGNORE_SERVER_IDS=413, IMPORT=414, INDEXES=415, 
		INITIAL_SIZE=416, INPLACE=417, INSERT_METHOD=418, INSTALL=419, INSTANCE=420, 
		INVISIBLE=421, INVOKER=422, IO=423, IO_THREAD=424, IPC=425, ISOLATION=426, 
		ISSUER=427, JSON=428, KEY_BLOCK_SIZE=429, LANGUAGE=430, LAST=431, LEAVES=432, 
		LESS=433, LEVEL=434, LIST=435, LOCAL=436, LOGFILE=437, LOGS=438, MASTER=439, 
		MASTER_AUTO_POSITION=440, MASTER_CONNECT_RETRY=441, MASTER_DELAY=442, 
		MASTER_HEARTBEAT_PERIOD=443, MASTER_HOST=444, MASTER_LOG_FILE=445, MASTER_LOG_POS=446, 
		MASTER_PASSWORD=447, MASTER_PORT=448, MASTER_RETRY_COUNT=449, MASTER_SSL=450, 
		MASTER_SSL_CA=451, MASTER_SSL_CAPATH=452, MASTER_SSL_CERT=453, MASTER_SSL_CIPHER=454, 
		MASTER_SSL_CRL=455, MASTER_SSL_CRLPATH=456, MASTER_SSL_KEY=457, MASTER_TLS_VERSION=458, 
		MASTER_USER=459, MAX_CONNECTIONS_PER_HOUR=460, MAX_QUERIES_PER_HOUR=461, 
		MAX_ROWS=462, MAX_SIZE=463, MAX_UPDATES_PER_HOUR=464, MAX_USER_CONNECTIONS=465, 
		MEDIUM=466, MEMBER=467, MERGE=468, MESSAGE_TEXT=469, MID=470, MIGRATE=471, 
		MIN_ROWS=472, MODE=473, MODIFY=474, MUTEX=475, MYSQL=476, MYSQL_ERRNO=477, 
		NAME=478, NAMES=479, NCHAR=480, NEVER=481, NEXT=482, NO=483, NODEGROUP=484, 
		NONE=485, OFFLINE=486, OFFSET=487, OF=488, OJ=489, OLD_PASSWORD=490, ONE=491, 
		ONLINE=492, ONLY=493, OPEN=494, OPTIMIZER_COSTS=495, OPTIONS=496, OWNER=497, 
		PACK_KEYS=498, PAGE=499, PARSER=500, PARTIAL=501, PARTITIONING=502, PARTITIONS=503, 
		PASSWORD=504, PHASE=505, PLUGIN=506, PLUGIN_DIR=507, PLUGINS=508, PORT=509, 
		PRECEDES=510, PREPARE=511, PRESERVE=512, PREV=513, PROCESSLIST=514, PROFILE=515, 
		PROFILES=516, PROXY=517, QUERY=518, QUICK=519, REBUILD=520, RECOVER=521, 
		REDO_BUFFER_SIZE=522, REDUNDANT=523, RELAY=524, RELAY_LOG_FILE=525, RELAY_LOG_POS=526, 
		RELAYLOG=527, REMOVE=528, REORGANIZE=529, REPAIR=530, REPLICATE_DO_DB=531, 
		...
		REPLICATION=538, RESET=539, RESUME=540, RETURNED_SQLSTATE=541, RETURNING=542, 
		RETURNS=543, ROLE=544, ROLLBACK=545, ROLLUP=546, ROTATE=547, ROW=548, 
		ROWS=549, ROW_FORMAT=550, SAVEPOINT=551, SCHEDULE=552, SECURITY=553, SERVER=554, 
		SESSION=555, SHARE=556, SHARED=557, SIGNED=558, SIMPLE=559, SLAVE=560, 
		SLOW=561, SNAPSHOT=562, SOCKET=563, SOME=564, SONAME=565, SOUNDS=566, 
		SOURCE=567, SQL_AFTER_GTIDS=568, SQL_AFTER_MTS_GAPS=569, SQL_BEFORE_GTIDS=570, 
		SQL_BUFFER_RESULT=571, SQL_CACHE=572, SQL_NO_CACHE=573, SQL_THREAD=574, 
		START=575, STARTS=576, STATS_AUTO_RECALC=577, STATS_PERSISTENT=578, STATS_SAMPLE_PAGES=579, 
		STATUS=580, STOP=581, STORAGE=582, STORED=583, STRING=584, SUBCLASS_ORIGIN=585, 
		SUBJECT=586, SUBPARTITION=587, SUBPARTITIONS=588, SUSPEND=589, SWAPS=590, 
		SWITCHES=591, TABLE_NAME=592, TABLESPACE=593, TEMPORARY=594, TEMPTABLE=595, 
		THAN=596, TRADITIONAL=597, TRANSACTION=598, TRANSACTIONAL=599, TRIGGERS=600, 
		TRUNCATE=601, UNDEFINED=602, UNDOFILE=603, UNDO_BUFFER_SIZE=604, UNINSTALL=605, 
		UNKNOWN=606, UNTIL=607, UPGRADE=608, USER=609, USE_FRM=610, USER_RESOURCES=611, 
		VALIDATION=612, VALUE=613, VARIABLES=614, VIEW=615, VIRTUAL=616, VISIBLE=617, 
		WAIT=618, WARNINGS=619, WITHOUT=620, WORK=621, WRAPPER=622, X509=623, 
		XA=624, XML=625, EUR=626, USA=627, JIS=628, ISO=629, INTERNAL=630, QUARTER=631, 
		MONTH=632, DAY=633, HOUR=634, MINUTE=635, WEEK=636, SECOND=637, MICROSECOND=638, 
